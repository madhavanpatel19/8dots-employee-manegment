                    ...
                    <tr class="table-row-hover">
                        <td style="padding: 15px 20px; vertical-align: middle;">
                            <div style="display: flex; align-items: center; justify-content: flex-start; gap: 12px;">
                                <div style="width: 32px; height: 32px; border-radius: 6px; background: ${isPrivate ? '#e0f2fe' : 'rgb(34 35 35 / 20%);'}; color: ${isPrivate ? '#0284c7' : '#232223'}; display: flex; align-items: center; justify-content: center; font-size: 16px;">
                        ...
                        <td style="padding: 15px 20px; text-align: center; vertical-align: middle;">
                            <span style="color: ${isPrivate ? '#0284c7' : '#232223'}; cursor: pointer; font-size: 14px; font-weight: 500;" onclick="openResourceHub('${item.category}', '${mode}')">${item.category} ${isPrivate ? '(Private)' : ''}</span>
                        </td>
