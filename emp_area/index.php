...
?>
    ...
    <head>
        ...
        <link href="../admin_area/css/style.css?v=<?php echo time(); ?>" rel="stylesheet">
        <link href="../admin_area/css/dashboard.css?v=<?php echo time(); ?>" rel="stylesheet">
        <link href="../admin_area/css/sidebar.css?v=<?php echo time(); ?>" rel="stylesheet">
