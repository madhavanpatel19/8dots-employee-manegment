...
<div class="page-wrapper premium-ui-enabled">
    ...
    <div class="premium-card" style="background: #fff; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
        <div class="card-hdr" style="padding: 20px 24px; background: var(--p-bg-header); border-bottom: 1px solid #e2e8f0; display: flex; align-items: center; gap: 10px; color:white">
            ...
            <h3 style="margin: 0; font-size: 16px; font-weight: 700;">Experience Letters History</h3>
        </div>
            ...
            <table class="table-premium" style="width: 100%; border-collapse: separate; border-spacing: 0;">
                <thead>
                    <tr style="background: #fff;">
                        ...
                        <th style="padding: 15px; color: #64748b; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 2px solid #f1f5f9;">Employee Name</th>
                        <th style="padding: 15px; color: #64748b; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 2px solid #f1f5f9;">Designation</th>
                        <th style="padding: 15px; color: #64748b; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 2px solid #f1f5f9;">Working Period</th>
