                ...
                <div class="modal-body" style="padding: 30px; background: #fff;">
                    <div class="row">
                        <div class="col-md-6" style="margin-bottom: 20px;">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Employee Name" required style="height: 50px; background: #f8fafc; border: 1.5px solid #e2e8f0; border-radius: 14px; padding: 12px 20px; width: 100%; color: #0f172a; font-weight: 600; outline: none; transition: all 0.3s;" onfocus="this.style.borderColor='var(--p-bg-color)'; this.style.boxShadow='0 4px 10px rgba(166, 166, 167, 0.2);';" onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none';">
                        </div>
                        <div class="col-md-6" style="margin-bottom: 20px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="margin-bottom: 20px;">
                            ...
                            <input type="tel" name="number" class="form-control" maxlength="10" placeholder="Phone Number" style="height: 50px; background: #f8fafc; border: 1.5px solid #e2e8f0; border-radius: 14px; padding: 12px 20px; width: 100%; color: #0f172a; font-weight: 600; outline: none; transition: all 0.3s;" onfocus="this.style.borderColor='var(--p-bg-color)'; this.style.boxShadow='0 4px 10px rgba(166, 166, 167, 0.2);';" onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none';">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6" style="margin-bottom: 20px;">
