...
?>
    <style>
        .table-premium th { text-align: center !important; }
        .table-premium td:nth-child(3), .table-premium th:nth-child(3) { text-align: left !important; }
        .table-premium td:nth-child(5), .table-premium th:nth-child(5) { text-align: left !important; }
        .p-badge-primary { background: rgba(79, 70, 229, 0.1); color: #4f46e5; }
        .p-badge-info { background: rgba(14, 165, 233, 0.1); color: #0ea5e9; }
        .p-badge-danger { background: rgba(239, 68, 68, 0.1); color: #ef4444; }
    </style>
...
function copyToClipboard(text) {
    ...
    setTimeout(() => {
        if(confirm('Link copied! Would you like to open the form in a new tab for preview?')) {
