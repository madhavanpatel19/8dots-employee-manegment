                            ...
                            ?>
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px;">
                                        <label style="font-weight: 500; color: #475569; cursor: pointer; margin: 0; font-size: 13px;">
                                            <input type="checkbox" name="industry[]" value="<?php echo htmlspecialchars($i_name); ?>" <?php echo $checked; ?> style="margin-right: 8px; width: 14px; height: 14px; vertical-align: middle; accent-color: #232223;"> <?php echo htmlspecialchars($i_name); ?>
                                        </label>
