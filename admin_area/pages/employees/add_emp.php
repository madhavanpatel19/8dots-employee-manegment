...
function add_user($con)
{
    ...
    if ($run) {
        ...
        //             <h2 style='color:#232223;'>Welcome to 8Dots!</h2>
        ...
        <div class="success-modal-overlay" id="successModal">
            <div class="success-modal-content">
                ...
                <p class="success-message">
                    ...
                    <small style="color:#64748b;">Login Password: <strong style="color:#232223;"><?php echo htmlspecialchars($plainPassword); ?></strong></small>
                </p>
