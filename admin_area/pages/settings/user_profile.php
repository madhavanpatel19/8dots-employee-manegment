...
<div class="page-wrapper premium-ui-enabled">
    <div class="page-header-premium">
        ...
        <div class="header-actions-premium">
            <a href="index.php?dashboard" class="btn-premium-add" style="background: #f1f5f9 !important; color: #475569 !important; border: 1.5px solid #e2e8f0 !important; box-shadow: none !important;">
        ...
        <div style="padding: 40px;">
            <form method="post" enctype="multipart/form-data">
                ...
                <div style="margin-top: 50px; text-align: right; border-top: 1.5px solid #f1f5f9; padding-top: 30px;">
                    <button type="submit" name="update" class="btn-premium-add" style="padding: 14px 40px !important; font-size: 16px !important;">
