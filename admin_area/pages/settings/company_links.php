...
<style>
    ...
    .select2-container--default .select2-selection--multiple .select2-selection__choice {
        background-color: rgb(34 35 35 / 20%);
        !important;
    ...
    .select2-container--default .select2-selection--multiple .select2-selection__choice__remove:hover {
        background-color: rgba(35, 34, 35, 0.15) !important;
    ...
    <div id="resource-hub-view" style="display: none; width: 100%;">
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 30px;">
            <div style="display: flex; align-items: center; gap: 20px;">
                <div style="width: 60px; height: 60px; background: rgb(34 35 35 / 20%);; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 28px; color: #232223;">
                ...
                <div>
                    <h2 id="hub-section-title" style="margin: 0; color: #0f172a; font-size: 24px; font-weight: 800; display: flex; align-items: center; gap: 10px;">
                        ...
                        <?php if (canAdminAccess('company_link_update')): ?>
                            <i id="btn-rename-section" class="fa fa-pencil" style="font-size: 14px; color: #232223; cursor: pointer;" title="Rename Section"></i>
                        <?php endif; ?>
                    </h2>
                    <p id="hub-section-stats" style="margin: 4px 0 0 0; color: #232223; font-size: 14px; font-weight: 500;">
        ...
        <div style="margin-bottom: 40px;" id="files-section-container">
            ...
            <div style="border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; background: #fff;">
                ...
                <div id="view-all-files-container" style="padding: 15px 20px; background: #fff; border-top: 1px solid #e2e8f0; display: none;">
                    <a href="#" id="view-all-files-btn" style="color: #232223; font-size: 14px; font-weight: 600; text-decoration: none; outline: none;">View all files</a>
                </div>
            </div>
        </div>
        ...
        <div id="links-section-container">
            ...
            <div style="border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; background: #fff;">
                ...
                <div id="view-all-links-container" style="padding: 15px 20px; background: #fff; border-top: 1px solid #e2e8f0; display: none;">
                    <a href="#" id="view-all-links-btn" style="color: #232223; font-size: 14px; font-weight: 600; text-decoration: none; outline: none;">View all links</a>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden; box-shadow: 0 20px 40px -10px rgba(0,0,0,0.2);">
            <div class="modal-header" style="border-bottom: 1px solid #f1f5f9; padding: 20px 24px; background: rgb(34 35 35 / 20%);; border-radius: 14px 14px 0 0; position: relative;">
                <div style="display: flex; align-items: center; width: 100%; gap: 12px;">
                    ...
                    <div>
                        <h5 class="modal-title" style="font-weight: 800; color: #0f172a; font-size: 17px; margin: 0;">Assign Access to <span id="assign-section-name" style="color: #232223;"></span></h5>
                    </div>
                </div>
                    ...
                    <div style="max-height: 300px; overflow-y: auto; border: 1px solid #e2e8f0; border-radius: 8px; padding: 15px;">
                        ...
                        ?>
                            <label style="display: flex; align-items: center; gap: 15px; padding: 10px; border-bottom: 1px solid #f1f5f9; cursor: pointer; margin: 0;">
                                <input type="checkbox" name="emp_ids[]" value="<?php echo $e['id']; ?>" class="emp-checkbox" style="width: 18px; height: 18px; accent-color: #232223;">
...
<script>
    $(document).ready(function() {
                ...
                <div class="folder-card" data-category="${cat}">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 20px;">
                        <div style="display: flex; gap: 15px; align-items: center;">
                            <div style="width: 50px; height: 50px; background: rgb(34 35 35 / 20%);; border-radius: 12px; display: flex; align-items: center; justify-content: center; color: #232223; font-size: 24px;">
                                <i class="fa fa-folder"></i>
                            </div>
                            <div>
                        ...
                        <div style="position: relative;" class="folder-menu-container">
                            ...
                            <div class="folder-dropdown" style="display: none; position: absolute; top: 100%; right: 0; background: #fff; border: 1px solid #e2e8f0; border-radius: 8px; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); margin-top: 5px; z-index: 100; min-width: 180px; overflow: hidden;">
                                <div class="btn-assign-folder" data-category="${cat}" style="padding: 12px 20px; cursor: pointer; font-size: 14px; font-weight: 500; color: #475569; transition: 0.2s;"><i class="fa fa-users" style="margin-right: 8px; color: #232223;"></i> Assign Access</div>
                            </div>
                        </div>
                    </div>
                ...
                <tr class="table-row-hover">
                    <td style="padding: 15px 20px; vertical-align: middle;">
                        <div style="display: flex; align-items: center; justify-content: flex-start; gap: 12px;">
                            <div style="width: 32px; height: 32px; border-radius: 6px; background: #232223; color: #fff; display: flex; align-items: center; justify-content: center; font-size: 16px;">
                    ...
                    <td style="padding: 15px 20px; text-align: center; vertical-align: middle;">
                        <span style="color: #232223; cursor: pointer; font-size: 14px;" onclick="openResourceHub('${item.category}')">${item.category}</span>
                    </td>
                    <td style="padding: 15px 20px; vertical-align: middle;">
        ...
        function openResourceHub(category) {
            ...
            files.forEach(({
                ...
                <tr class="${rowClass}" style="${displayStyle}">
                    <td style="padding: 12px 20px; vertical-align: middle;">
                        <div style="display: flex; align-items: center; justify-content: flex-start; gap: 12px;">
                            <div class="resource-icon-mini" style="background: rgb(34 35 35 / 20%);; color: #232223; width: 32px; height: 32px; font-size: 16px;">
                                <i class="fa ${typeInfo.icon}"></i>
                            </div>
                            <span style="color: #0f172a; font-weight: 500; font-size: 14px;">${item.link_name}</span>
                        </div>
            ...
            links.forEach(({
                ...
                <tr class="${rowClass}" style="${displayStyle}">
                    ...
                    <td style="padding: 12px 20px; text-align: center; vertical-align: middle;">
                        <a href="${url}" target="_blank" style="color: #232223; font-size: 13px; text-decoration: none; word-break: break-all;">${url}</a>
                    </td>
                    <td style="padding: 12px 20px; vertical-align: middle;">
                        <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
                            <img src="${item.uploader_photo ? 'uploads/' + item.uploader_photo : currentUserAvatar}" style="width: 24px; height: 24px; border-radius: 50%; object-fit: cover;">
        ...
        function formatEmployee(opt) {
            ...
            if (opt.id === 'all') {
                return $('<span><i class="fa fa-users" style="margin-right: 8px; color: #232223;"></i>' + opt.text + '</span>');
            }
